<?php
/*
Plugin Name: LoveIt.com Importer
Description: Import images & videos from a LoveIt.com account.
Version: 0.1.1
Author: G.Breant
Author URI: http://sandbox.pencil2d.org
Plugin URI: http://wordpress.org/extend/plugins/loveitcom-importer
License: GPL2
*/



class LoveItDotComImporter {
    ...
    */
    ...
    public static function instance() {
            if ( ! isset( self::$instance ) ) {
                    self::$instance = new LoveItDotComImporter;
    ...
    function includes(){
        ...
        if ( ! class_exists( 'WP_Importer' ) ) {
                ...
                if ( file_exists( $class_wp_importer ) ) {
                    ...
                    require $this->plugin_dir . '/loveit-importer-class.php';
                }
        }

        if ( ! class_exists( 'LoveItGalleryParser' ) ) {
            require $this->plugin_dir . '/loveit-importer-parsers.php';
        }
    ...
    function load_textdomain() {
        load_plugin_textdomain( 'loveit-wp-importer', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
    }
    ...
    function register_importer() {
            ...
            */
            $GLOBALS['loveit_wp_import'] = new LoveIt_WP_Importer();
            register_importer( 'loveit-html', 'LoveIt', sprintf(__('Import <strong>images and videos</strong> from your %s account to Wordpress', 'loveit-wp-importer'),'<a href="http://www.loveit.com" target="_blank">LoveIt.com</a>'), array( $GLOBALS['loveit_wp_import'], 'dispatch' ) );
    }
...
function loveitdotcom_importer() {
	return LoveItDotComImporter::instance();
}

loveitdotcom_importer();